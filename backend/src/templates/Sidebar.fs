...
let sidebar =
    div [className "sidebar"] [
        ...
        p [] ["Hey what is up I am Mark (the one in the picture!), a complete nerd and pizza enthusiast. I mostly write about technology and I am not afraid to use the M word: Monad. There I said it."]
